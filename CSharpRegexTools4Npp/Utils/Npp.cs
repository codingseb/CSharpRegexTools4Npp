...
namespace CSharpRegexTools4Npp.Utils
{
    ...
    public class Npp
    {
        ...
        /// </summary>
        public static NotepadPPGateway Notepad { get; set; } = new NotepadPPGateway();
        ...
        public static string Text
        {
            get
            {
                ScintillaGateway scintilla = Editor;
        ...
        public static int SelectionStart
        {
            ...
            set
            {
                Editor.SetSelectionStart((new TextPosition(value)).Value);
            }
        }
        ...
        public static int SelectionEnd
        {
            ...
            set
            {
                ...
                string afterText = allText.Substring(0, (int)endToUse);
