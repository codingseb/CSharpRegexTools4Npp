...
namespace CSharpRegexTools4Npp.Utils
{
    ...
    public class Npp
    {
        ...
        /// </summary>
        public static IScintillaGateway Editor { get; set; } = new ScintillaGateway(PluginBase.GetCurrentScintilla());
        /// <summary>
        /// connector to Notepad++
        /// </summary>
        public static INotepadPPGateway Notepad { get; set; } = new NotepadPPGateway();
